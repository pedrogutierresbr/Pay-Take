...
Ter o servidor criado para essa aplicação em seu computar, e executá-lo antes desta aplicação. Você pode encontrá-lo em: [Servidor-api-pay-take]()
